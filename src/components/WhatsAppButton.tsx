...
export default function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-8 right-8 z-50 flex sm:flex-row flex-col gap-4">
      {/* Phone Button */}
      <div className="relative">
        <div className="absolute inset-0 bg-blue-500 rounded-full animate-ping opacity-75"></div>
        <button
          onClick={handlePhoneClick}
          className="relative bg-blue-500 text-white p-4 rounded-full shadow-lg hover:bg-blue-600 transition-colors"
        >
          <svg
